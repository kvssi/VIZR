...
- **System statt Filter:** VIZR ist kein einfacher Bildfilter. Es ist ein System, das Bilder in Rollen (Background, Poster, Logo, Overlay) einteilt und diese intelligent kombiniert (z.B. durch automatische "White Transparency" für nahtloses Blending).
...
- **Asset Editor:** Ein integrierter Editor hilft dir, deine Bilder vorzubereiten, Rollen zuzuweisen und Dateinamen automatisch zu generieren, ohne das Projekt verlassen zu müssen.
